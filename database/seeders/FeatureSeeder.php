...
class FeatureSeeder extends Seeder
{
    ...
    private function features(): array
    {
        return [
            ...
            ['key' => 'job_photos', 'name' => 'Job photos', 'description' => 'Up to 15 photos on a garage job. Visible on the customer bill link. Deleted after 6 months. Off until super-admin enables it.', 'group' => 'Service Intake', 'sort_order' => 15],
            ['key' => 'job_videos', 'name' => 'Job videos', 'description' => 'Up to 5 compressed clips on a garage job. Visible on the customer bill link. Deleted after 6 months. Off until super-admin enables it.', 'group' => 'Service Intake', 'sort_order' => 16],
            ['key' => 'job_bookings', 'name' => 'Bay calendar', 'description' => 'Day view of bays, time slots, vehicles, and technicians. Off until super-admin enables it.', 'group' => 'Service Intake', 'sort_order' => 17],
            ...
            ['key' => 'parts_inventory', 'name' => 'Inventory', 'description' => 'Garage stock and inventory', 'group' => 'Inventory', 'sort_order' => 40],
            ...
            ['key' => 'station_consumables', 'name' => 'Station consumables', 'description' => 'Issue bulk tins (e.g. Hypower, shampoo) to the wash bay. Stock drops when opened; cost per wash and profit are worked out from billed service addons. Off until super-admin enables it.', 'group' => 'Inventory', 'sort_order' => 47],
