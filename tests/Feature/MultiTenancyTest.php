...
class MultiTenancyTest extends TestCase
{
    ...
    {
        foreach (['admit_vehicle', 'billing', 'payroll', 'balance_sheet', 'parts_inventory', 'employees_management', 'reports'] as $key) {
            Feature::firstOrCreate(['key' => $key], ['name' => str($key)->headline()]);
        }
    }
}
