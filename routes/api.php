...
Route::middleware(['auth:sanctum', 'user.active', 'tenant.active', 'branch.context'])->group(function () {
    ...
    Route::prefix('super-admin')->middleware('role:super_admin')->group(function () {
        ...
        Route::post('/tenants/{tenant}/bills/{bill}/close', [SuperAdminBillController::class, 'close']);
        Route::delete('/tenants/{tenant}/bills/{bill}', [SuperAdminBillController::class, 'destroy']);
        Route::post('/tenants/{tenant}/bills/{bill}/items', [SuperAdminBillController::class, 'storeItem']);
        Route::put('/tenants/{tenant}/bills/{bill}/items/{item}', [SuperAdminBillController::class, 'updateItem']);
        Route::delete('/tenants/{tenant}/bills/{bill}/items/{item}', [SuperAdminBillController::class, 'destroyItem']);
        Route::post('/tenants/{tenant}/bills/{bill}/payments', [SuperAdminBillController::class, 'storePayment']);
        Route::delete('/tenants/{tenant}/bills/{bill}/payments/{payment}', [SuperAdminBillController::class, 'destroyPayment']);
        ...
        Route::middleware('feature:billing')->group(function () {
            ...
            Route::get('/service-vehicle-classes', [ServiceVehicleClassController::class, 'index']);
